...
export IMAGE_URL=quay.io/redhat-appstudio/dance-bootstrap-app:latest:$CI_TYPE-$TAG
...
export GITOPS_REPO_URL=https://github.com/rhtap-qe-jsmid/dotnetjenkinsgithub291024-gitops
